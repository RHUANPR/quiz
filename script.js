...
const quizdata=[
      {
        question:"Onde ocorreu o primeiro vôo de Santos Dumont com o 14-bis?",
        options:["Aeroporto de Orly, França", "Campo de Bagatelle, Paris", "Santos, Brasil", "Londres, Reino Unido"],
        answer:"Campo de Bagatelle, Paris",
        category:1
      },
      {
        question:"Quais números Santos Dumont sempre evitava?",
        options:["3, 6, 9", "13, 17, 21", "7, 11, 15", "8, 13, 50"],
        answer:"8, 13, 50",
        category:2
      },
      {
        question:"Quantos balões foram projetados por Santos Dumont?",
        options:["7 - Brésil, L'Amérique, Le Fatum, Nº 11, Deux Amériques, L'Étoile, La Plata", "3 - Brésil, L'Amérique, Nº 11", "5 - Brésil, L'Amérique, Le Fatum, Nº 11, Deux Amériques", "9 - Brésil, L'Amérique, Le Fatum, Nº 11, Deux Amériques, L'Étoile, La Plata, Le Globe, Le Rouquin"],
        answer:"5 - Brésil, L'Amérique, Le Fatum, Nº 11, Deux Amériques",
        category:3
      },
      {
        question:"O que mais Santos Dumont criou, fora os aviões/dirigíveis?",
        options:["Chuveiro Quente e Relógio de pulso.", "Telefone e Fotografia colorida.", " Computador pessoal e Impressora a jato de tinta.", "Máquina de lavar roupa e Lâmpada elétrica."],
        answer:"Chuveiro Quente e Relógio de pulso.",
        category:1
      },
      {
        question:"Qual foi o objetivo de Santos Dumont que o levou a desenvolver seus dirigíveis/aviões?",
        options:["Ele queria estabelecer recordes de velocidade no ar.", "Ele estava interessado em ganhar prêmios em competições de aviação.", "Ele queria controlar o voo, tornando o que se usava para voar 'dirigível'", "Ele planejava transportar cargas pesadas em sua invenção."],
        answer:"Ele queria controlar o voo, tornando o que se usava para voar 'dirigível'",
        category:2
      },
      {
        question:"Em 1910, Santos Dumont foi diagnosticado com qual doença?",
        options:["Diabetes.", "Tuberculose.", "Pneumonia.", "Esclerose múltipla."],
        answer:"Esclerose múltipla.",
        category:3
      },
      {
        question:"Quem passou a cuidar de Santos Dumont em seus últimos anos de vida?",
        options:["Seu médico pessoal.", "Seu melhor amigo, Alberto Santos-Dumont.", "Seu sobrinho, Jorge Dumont Vilares.", "Uma equipe de enfermeiros especializados."],
        answer:"Seu sobrinho, Jorge Dumont Vilares.",
        category:2
      },
      {
        question:"O que contribuiu para abalar ainda mais a saúde mental de Santos Dumont?",
        options:["Suas preocupações com o meio ambiente.", "A falta de reconhecimento por suas inovações.", "Seus aviões sendo utilizados na Revolução Constitucionalista.", "Pressões financeiras em sua vida pessoal."],
        answer:"Seus aviões sendo utilizados na Revolução Constitucionalista.",
        category:3
      },
      {
        question:"Em que cidade Alberto Santos Dumont completou seu famoso voo ao redor da Torre Eiffel em 1901?",
        options:["Rio de Janeiro", "São Paulo", "Paris", "Londres"],
        answer:"Paris",
        category:1
      },
      {
        question:"Qual é o nome do avião em que Santos Dumont conquistou o Prêmio Archdeacon, voando uma distância de 220 metros em 1906?",
        options:["14-Bis", "Demoiselle", "Oiseau de Proie", "19-Bis"],
        answer:"14-Bis",
        category:2
      },
      {
        question:"Em qual cidade Santos Dumont nasceu?",
        options:["Rio de Janeiro.", "São Paulo.", "Belo Horizonte.", " Cabangu."],
        answer:" Cabangu.",
        category:3
      },
      {
        question:"Em que ano Santos Dumont fez seu famoso voo do 14-Bis em Paris?",
        options:["1901.", "1906.", "1907.", "1910."],
        answer:"1906.",
        category:1
      }
    ];
    ...
    function _animateCircle() {
      //2*pi*r == 753.6 +xxx=764
        ...
        if (_percentage >= _input_percentage) {
             _text_percentage.html('<tspan x="50%" dy="0em">'+unchnagedPer + '% </tspan><tspan  x="50%" dy="1.9em">Parabéns Esse Foi Seu Resultado</tspan>');
